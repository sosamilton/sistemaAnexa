...
class Alumno {
	...
	*/
	...
	/**
	* @var integer
	* @Column (name="dni", type="integer", unique=true)
	*/
	protected $dni;
	...
	*/
	...
	/**
	* @var string
	* @Column (name="calle", type="string", length=255)
	*/
	protected $calle;
	...
	*/
	...
	/**
	* @var string
	* @Column (name="ciudad", type="string", length=255)
	*/
	protected $ciudad;

	/**
	* @var string
	* @Column (name="provincia", type="string", length=255)
	*/
	protected $provincia;

	/**
	* @var string
	* @Column (name="codigoPostal", type="string", length=255)
	*/
	protected $codigoPostal;

	/**
	* @var string
	* @Column (name="pais", type="string", length=255)
	*/
	protected $pais;
	...
	*/
	...
	/**
	* @var datetime
	* @Column (name="fechaEgreso", type="datetime", nullable=true)
	*/
	...
	*/
	...
	/**
	* @ManyToMany(targetEntity="Responsable", inversedBy="alumnos")
	* @JoinTable(name="Responsables_Alumnos")
    */
    protected $responsables;


    /**
    * @OneToMany(targetEntity="Pago", mappedBy="alumno")
    */
    protected $pagos;
